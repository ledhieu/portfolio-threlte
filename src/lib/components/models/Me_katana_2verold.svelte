...
onMount(() => {
  gltf.then(gltf => {
    ...
    //   map: hair.map
    // })
    glowMaterial.emissiveIntensity = 400
    console.log(glow)
    glowMaterial = new THREE.MeshLambertMaterial({
      color: new THREE.Color(0x2200ff),
      emissive: new THREE.Color(0x2200ff),
      emissiveColor: new THREE.Color(0x2200ff),
...
<T is={ref} dispose={false} {...$$restProps} bind:this={$component}>
  ...
  {:then gltf}
    <T.Group name="mech_me_-_animation">
      ...
      {#if darkMode}
      <T.Mesh
        name="������������005_Material001_0035"
        geometry={gltf.nodes['������������005_Material001_0035'].geometry}
      ...
      />
      <T.Mesh
        name="������������005_Material001_0055"
        geometry={gltf.nodes['������������005_Material001_0055'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0105"
        geometry={gltf.nodes['������������005_Material001_0105'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0132"
        geometry={gltf.nodes['������������005_Material001_0132'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0153"
        geometry={gltf.nodes['������������005_Material001_0153'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0179"
        geometry={gltf.nodes['������������005_Material001_0179'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0180"
        geometry={gltf.nodes['������������005_Material001_0180'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0181"
        geometry={gltf.nodes['������������005_Material001_0181'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0186"
        geometry={gltf.nodes['������������005_Material001_0186'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0187"
        geometry={gltf.nodes['������������005_Material001_0187'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0188"
        geometry={gltf.nodes['������������005_Material001_0188'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0189"
        geometry={gltf.nodes['������������005_Material001_0189'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0190"
        geometry={gltf.nodes['������������005_Material001_0190'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0191"
        geometry={gltf.nodes['������������005_Material001_0191'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0193"
        geometry={gltf.nodes['������������005_Material001_0193'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0194"
        geometry={gltf.nodes['������������005_Material001_0194'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0200"
        geometry={gltf.nodes['������������005_Material001_0200'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0241"
        geometry={gltf.nodes['������������005_Material001_0241'].geometry}
        material={gltf.materials['Material.009']}
        position={[0, 1.63, 0.13]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={0.01}
      />
      <T.Mesh
        name="������������005_Material001_0350"
        geometry={gltf.nodes['������������005_Material001_0350'].geometry}
