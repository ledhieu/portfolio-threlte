...
Command: npx @threlte/gltf@2.0.3 me_katana_2ver_optimized6.glb --transform
-->
...
<script>
  ...
  // sth
  const gltf = useGltf('/models/me_katana_2ver_optimized6-transformed.glb', { useDraco: true })
  ...
  {:then gltf}
    <T.Group name="Scene">
      <T.Group name="Armature022">
        ...
        <T.Group name="Wolf3D_Hair005" />
        <T.Group name="Wolf3D_Teeth005" />
      ...
      <T.Group name="Wolf3D_Outfit_Footwear009" />
      <T.Group
        name="Skin_ZSphere1_23002"
        position={[-0.05, 0.67, 0.08]}
        rotation={[0, 0, 0.08]}
        scale={[0.3, 0.32, 0.32]}
      />
      ...
      <T.Group name="glasses" position={[0, 1.69, 0.05]} rotation={[-Math.PI / 2, 0, 0]} scale={0.02} />
      <T.Group name="Wolf3D_Head001" />
      <T.Group name="Wolf3D_Head004" />
      <T.Group name="Wolf3D_Head005" />
      <T.Group name="Wolf3D_Head006" />
      <T.Group name="Wolf3D_Head012" />
      <T.Group name="Wolf3D_Head013" />
      <T.Group name="Wolf3D_Head018" />
      <T.Group name="Wolf3D_Head019" />
      <T.Group name="Wolf3D_Head022" />
      <T.Group name="Wolf3D_Head023" />
      <T.Group name="Wolf3D_Head024" />
      <T.Group name="Wolf3D_Head025" />
      <T.Group name="Wolf3D_Head026" />
      <T.Group name="Mask3_blinn1_0001" position={[0, 1.71, 0.11]} rotation={[-0.18, 0, 0]} scale={0} />
    </T.Group>
  {:catch error}
